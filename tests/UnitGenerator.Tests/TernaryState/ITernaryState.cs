...
/// <summary>
/// ITernaryState 3状態を表現するインターフェイス ITernaryState (UNDEF, NULL, Value)
/// </summary>
public interface ITernaryState
{
    ...
    public static ITernaryState UndefValue { get; }
    ...
    /// </returns>
    public static byte CheckState(in ITernaryState x, in ITernaryState y)
        => (x, y) switch
        {
    ...
    /// </returns>
    public static byte CheckState(in ITernaryState x)
        => x switch
        {
