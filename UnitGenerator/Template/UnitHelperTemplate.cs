...
namespace NullableUnitGenerator.Template
{
    ...
    public partial class UnitHelperTemplate : UnitHelperTemplateBase
    {
        /// <summary>
        ...
        {
            this.Write(@"#pragma warning disable CS8669  // Null 許容参照型の注釈は、'#nullable' 注釈のコンテキスト内のコードでのみ使用する必要があります。自動生成されたコードには、ソースに明示的な '#nullable' ディレクティブが必要です。
...
");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class UnitHelperTemplateBase
    {
        #region Fields
