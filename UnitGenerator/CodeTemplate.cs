...
if (IsIntegralNumericType()) { 
            this.Write("        /// <summary>Represents the largest possible value. This field is constan" +
                    "t.</summary>\r\n        public const ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(" MaxValue = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            ...
            this.Write("        readonly bool m_isDefined = false;\r\n        readonly bool m_hasValue = fa" +
                    "lse;\r\n        readonly ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            ...
            this.Write(");\r\n\r\n        /// <summary>undefined value instance.</summary>\r\n        public st" +
                    "atic ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            this.Write(" UndefinedValue => new();\r\n\r\n        /// <summary>null value instance.</summary>\r" +
                    "\n        public static ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write("));\r\n\r\n        /// <summary>default value instance.</summary>\r\n        public sta" +
                    "tic Type PrimitiveType => typeof(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(");\r\n\r\n\r\n        /// <summary>true if assigned; otherwise, false.</summary>\r\n");
 if (HasFlag(UnitGenerateOptions.JsonConverter)) { 
            this.Write("        [JsonIgnore]\r\n");
 } 
            this.Write("        public bool IsDefined => m_isDefined;\r\n\r\n        /// <summary>true if ass" +
                    "igned and not null; otherwise, false.</summary>\r\n");
 if (HasFlag(UnitGenerateOptions.JsonConverter)) { 
            this.Write("        [JsonIgnore]\r\n");
 } 
        ...
        /// <summary>return value if assigned and not null; otherwise, null</summary>
        /// <returns>value : if assigned and not null <br/> null : otherwise</returns>
        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(TypeNullable));
            this.Write(" GetValueOrNull() => HasValue ? m_value : null;\r\n\r\n        /// <summary>return va" +
                    "lue if assigned and not null; otherwise, default(");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(")</summary>\r\n        /// <returns>value : if assigned and not null <br/> default(" +
                    "");
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(Type));
            this.Write(");\r\n\r\n        /// <summary>return value if assigned and not null; otherwise, defa" +
                    "ultValue</summary>\r\n        /// <returns>value : if assigned and not null <br/> " +
                    "defaultValue : otherwise</returns>\r\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(TypeNullable));
            ...
            this.Write(" defaultValue) => HasValue ? m_value : defaultValue;\r\n\r\n        /// <inheritdoc c" +
                    "ref=\"GetValueOrNull()\" />\r\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(TypeNullable));
            this.Write(" AsPrimitive() => GetValueOrNull();\r\n\r\n\r\n        //\r\n        // Constructor\r\n    " +
 ...
 if (HasFlag(UnitGenerateOptions.Validate)) { 
        ...
        public override int GetHashCode()
            => new { m_isDefined, m_hasValue, m_value }.GetHashCode();
...
");
 if (ToStringFormat == null) { 
            this.Write("            => HasValue ? m_value.ToString() : $\"<{(!m_isDefined ? \"undefined\" : " +
                    "\"null\")}>\";\r\n");
 } else { 
            ...
            => m_value.Equals(other.m_value) &&
               m_hasValue.Equals(other.m_hasValue) &&
               m_isDefined.Equals(other.m_isDefined);
 ...
 if (Type == "Ulid" || Type == "System.Ulid") { 
        ...
        public static bool IsUndefinedOrNull(in ");
            ...
            this.Write(@" result)
        {
            if (!x.m_isDefined || !y.m_isDefined)
        {
                result = UndefinedValue;
                return true;
        }
            ...
            this.Write(@">;
                if (converter is not null)
                {
                    var res = (reader.TokenType) switch
                    {
                        ...
                        JsonTokenType.None => UndefinedValue,
                        _ => new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
...
if (IsSupportUtf8Formatter()) {  
 ...
 if (HasFlag(UnitGenerateOptions.DapperTypeHandler)) { 
            ...
            this.Write(@";
                parameter.Value = value.GetValueOrNull();
            }
        }
 ...
 if (HasFlag(UnitGenerateOptions.EntityFrameworkValueConverter)) { 
            ...
            this.Write("ValueConverter()\r\n                : base(\r\n                        convertToProvi" +
                    "derExpression: x => x.GetValueOrNull(),\r\n                        convertFromProv" +
                    "iderExpression: x => new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Name));
            ...
            this.Write(@"ValueConverter(Microsoft.EntityFrameworkCore.Storage.ValueConversion.ConverterMappingHints mappingHints = null)
                : base(
                        convertToProviderExpression: x => x.GetValueOrNull(),
            ...
            this.Write(@" wrappedValue)
                {
                    ...
                    {
                        return wrappedValue.GetValueOrNull();
                    }
                }
